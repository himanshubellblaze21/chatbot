...
# # # st.write("Upload a document and start a conversation with its content.")
...
# #         if speaker == "You":
# #             st.markdown(f"<div style='text-align: right;'><strong>{text}</strong> 🧑‍💻</div>", unsafe_allow_html=True)
# #         else:
# #             st.markdown(f"<div style='text-align: left;'><strong>🤖 AI:</strong> {text}</div>", unsafe_allow_html=True)
...
# #         st.success(f"File uploaded successfully to S3: [View File]({file_url})")
...
#     for speaker, text in st.session_state.chat_history:
#         if speaker == "You":
#             st.markdown(f"<div style='text-align: right; margin-bottom: 10px;'><strong>{text}</strong> 🧑‍💻</div>", unsafe_allow_html=True)
#         else:
#             st.markdown(f"<div style='text-align: left; margin-bottom: 10px;'><strong>🤖 AI:</strong> {text}</div>", unsafe_allow_html=True)
    
#     st.markdown("---")  # Add a separator for better spacing
    
#     col1, col2 = st.columns([6, 2], gap="medium")  # Add spacing between input and button
#     with col1:
#         user_query = st.text_input("Type your question here:", key="user_query_input", value=st.session_state.user_query, label_visibility="collapsed")
#     with col2:
#         send_button = st.button("💬 Send", key="send_button")
    
#     st.markdown("---")  # Add another separator before file uploader for better spacing
